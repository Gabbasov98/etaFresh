...
let maps=document.querySelectorAll("[data-cord1]");function init(o){maps.forEach(o=>{!function(o){let a=[+o.dataset.cord1,+o.dataset.cord2],e=new ymaps.Map(o,{center:a,zoom:17,controls:[]});e.behaviors.disable("scrollZoom"),e.controls.add("zoomControl");let t=new ymaps.Placemark(a,{},{iconLayout:"default#image",iconImageHref:"img/mark.svg",iconImageSize:[176,89],iconImageOffset:[-88,-44.5]});e.geoObjects.add(t)}(o)})}ymaps.ready(init);
